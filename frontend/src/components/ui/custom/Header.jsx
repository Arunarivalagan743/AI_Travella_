...
// import { FaUserCircle, FaSignOutAlt, FaSuitcaseRolling, FaHome, FaInfoCircle } from 'react-icons/fa';
...
//         {mobileMenuOpen && (
//           <motion.div
//             className="md:hidden absolute top-full left-0 right-0 backdrop-blur-lg bg-white/60 shadow-lg py-4 px-6 border-t border-gray-100"
...
//                   className={`flex items-center gap-2 text-gray-800 hover:text-emerald-600 font-medium py-2 px-1 border-b border-gray-100/50 relative group ${
//                     location.pathname === item.path ? 'text-emerald-700' : ''
//                   }`}
//                 >
//                   {item.icon}
...
//         {openDialog && (
//           <motion.div
//             className="fixed inset-0 mt-60 flex items-center justify-center z-[100] backdrop-blur-sm"
//             initial={{ opacity: 0 }}
//             animate={{ opacity: 1 }}
//             exit={{ opacity: 0 }}
