...
// Use hardcoded client ID if env variable is undefined
const googleClientId = import.meta.env.VITE_GOOGLE_AUTH_CLIENT_ID || 
  "500708772325-1r1s07l0hns50qnj1mci7o6e2c27q76e.apps.googleusercontent.com";
...
const router = createBrowserRouter([
  {
    ...
    children: [
      { index: true, element: <App /> },
      { path: 'create-trip', element: <CreateTrip /> },
      { path: 'show-trip/:id', element: <ViewTrip /> },
      { path: 'about', element: <About /> },
      { path: 'my-trips', element: <MyTrips /> }
    ]
  }
